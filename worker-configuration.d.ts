// Generated by Wrangler by running `wrangler types` (hash: 2b3622f6060828678d2a05edcfa51e9d)
// Runtime types generated with workerd@1.20250320.0 2025-03-21 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MONGODB_URI: string;
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").MongoDBConnector>;
	}
}
